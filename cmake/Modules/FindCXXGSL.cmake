...
set(CXXGSL_ROOT_DIR "${CXXGSL_ROOT_DIR}"
    CACHE PATH "The root to search for GSL")

if(TARGET GSL)
    set(CXXGSL_TARGET GSL)
    include(FindPackageHandleStandardArgs)
    find_package_handle_standard_args(CXXGSL
        REQUIRED_VARS
        CXXGSL_TARGET
    )
    ...
    ###
    if(CXXGSL_FOUND)
        set(CXXGSL_INCLUDE_DIRS
            ${CXXGSL_INCLUDE_DIR})

        if(NOT TARGET cxxgsl::gsl)
            add_library(cxxgsl::gsl INTERFACE IMPORTED)
        endif()
        set_target_properties(cxxgsl::gsl PROPERTIES
            INTERFACE_SYSTEM_INCLUDE_DIRECTORIES "${CXXGSL_INCLUDE_DIR}"
